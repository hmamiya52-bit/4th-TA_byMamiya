...
const ganttItems: GanttItem[] = [
  ...
  { title: "プロジェクトマネージャ対策アプリ開発", start: "2026/05-second", end: "2026/08-first", status: "完了" },
  {
  ...
  { title: "PDSアプリ用ノート作成（PM）", start: "2026/06-first", end: "2026/07-second", status: "完了" },
  ...
  { title: "PDSアプリ開発（基盤）", start: "2026/09-second", end: "2027/03-first", status: "予定" },
  { title: "令和8年度前期IPA高度試験受験者支援", start: "2026/10-first", end: "2026/11-second", status: "予定" },
  { title: "令和8年度後期IPA高度試験攻略隊編組", start: "2027/01-second", end: "2027/02-first", status: "予定" },
  { title: "R8後期高度試験攻略作戦", start: "2027/02-first", end: "2027/03-second", status: "予定" },
  { title: "PDS（マネジメント）アプリ実装・試験", start: "2027/02-first", end: "2027/05-second", status: "予定" },
  { title: "PDS資料：新シラバス対応作業", start: "2027/03-second", end: "2027/05-second", status: "予定" },
  { title: "PDSアプリ用ノート作成（AU/SM）", start: "2027/04-first", end: "2027/04-second", status: "予定" },
